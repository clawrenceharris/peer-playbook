    ...
    <BeforeUnload disabled={!isDirty}>
      <header className="header justify-start">
        ...
        <PlaybookCard
          ...
          className="border-border cursor-auto shadow-none"
        />
      </header>
      <div className="secondary-header flex flex-row justify-between">
      ...
      <div className="container">
        ...
        >
          ...
          >
            <ul className="grid w-full flex-1 grid-cols-1 gap-6 lg:grid-cols-3">
