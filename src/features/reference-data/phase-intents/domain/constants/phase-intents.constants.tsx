...
> = {
  activate: {
    icon: "bg-intent-activate/20 text-intent-activate",
  ...
  [PhaseIntent.EXPLORE]: {
    icon: "bg-intent-explore/20 text-intent-explore",
  ...
  [PhaseIntent.APPLY]: {
    icon: "bg-intent-apply/20 text-intent-apply",
  ...
  [PhaseIntent.REFLECT]: {
    icon: "bg-intent-reflect/20 text-intent-reflect",
  ...
  [PhaseIntent.TRANSITION]: {
    icon: "bg-intent-transition/20 text-intent-transition",
    activeStrategy:
