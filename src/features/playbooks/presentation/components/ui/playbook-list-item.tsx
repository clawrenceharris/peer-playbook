import { Delete, Playbook } from "@/components/icons";
import {
  Button,
  DropdownMenu,
  DropdownMenuContent,
...
import { Loader2, MoreVertical, StarIcon } from "lucide-react";
...
export const PlaybookListItem = ({
  ...
  // TODO: Add playbook sessions so we can show the playbook's session status in the list item
  ...
  return (
    ...
    >
      ...
      <ItemMedia
        variant="icon"
        className="[&_path]:stroke-muted-foreground bg-muted flex size-18 items-center justify-center rounded-[8px] border"
      >
        <Playbook className="text-muted-foreground transition-all duration-200 group-hover:scale-[1.2]" />
      </ItemMedia>
      <ItemContent>
